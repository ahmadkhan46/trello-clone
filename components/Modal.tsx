      ...
      onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className=' flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <Dialog.Panel className='w-full max-v-md transform overflow-hidden 
                ...
                <div className='mt-2'>
                  ...
                  className='w-full border-green-300 rounded-md outline-none
                  p-5'
                  />
                </div>
                ...
                <TaskTypeRadioGroup/>
                  ...
                  <div className='border-2 mt-2'>
                    ...
                    className='w-full border-solid border-gray-300 rounded-md outline-none p-5
                    ...
                    {image && (
                      ...
                      width={200}
                      height={200}
                      className='w-full h-44 object-cover mt-2 filter hover:grayscale translate-all 
