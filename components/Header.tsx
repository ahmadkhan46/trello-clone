    ...
    <header>
      <div className='flex flex-col md:flex-row items-center p-5
       bg-gray-500/10 gap-10' >
        ...
        <div className='flex items-center space-x-5 md:flex-auto md:pr-20 justify-center w-full flex-1 '>
          <form action={''}
           className='flex items-center space-x-5 bg-white
           rounded-md p-2 shadow-md flex-1 md:max-w-2xl'>
